...
const routes: Array<RouteRecordRaw> = [
    ...
    // ⭐ 管理后台路由
    {
        ...
        children: [
                                ...
                                children: [
                                    {
                                        ...
                                        name: "AwardedItem",
                                        component: () =>
                                            import("@/views/assess/awardedItem/List.vue"),
                                    },
                                ],
                            },
                            {
                                ...
                                children: [
                                    {
                                        ...
                                        name: "DeductionItem",
                                        component: () =>
                                            import("@/views/assess/deductionItem/List.vue"),
                                    },
                                ],
                            },
                            {
                                ...
                                children: [
                                    {
                                        ...
                                        name: "ScoreAndLevel",
                                        component: () =>
                                            import("@/views/assess/scoreAndLevel/List.vue"),
                                    },
                                ],
                            },
                        ],
            ...
            {
                path: "orgManage",
                name: "OrgManageLayout",
                component: () => import("@/layout/orgManage/Layout.vue"),
                children: [
                    {
                        path: "/admin/orgManage/:orgId/home",
                        name: "OrgManageHome",
                        component: () => import("@/views/organization/detail/Home.vue"),
                    },
                    {
                        path: "/admin/orgManage/:orgId/liveness",
                        name: "OrgManageLiveness",
                        component: () => import("@/views/organization/detail/Liveness.vue"),
                    },
                ],
            },
        ],
